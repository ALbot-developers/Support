 ...
 * @returns {Object} - 生成されたFAQ目次の埋め込みオブジェクト
 */
async function faqIndexGenerator(client, category = null) {
	try {
		// FAQが書かれているチャンネルを取得
		...
		console.log(`Error in faqIndexGenerator: ${err}`);
		return null;
	}
}

module.exports = faqIndexGenerator;
